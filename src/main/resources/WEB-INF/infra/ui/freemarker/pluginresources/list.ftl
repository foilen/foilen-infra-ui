    ...
    <tr>
      ...
      <td>
        ...
        <form class="confirm form-inline" method="post" action="/pluginresources/delete" data-confirm="<@spring.messageArgs 'prompt.delete.confirm' resourceNameArgs />">
          ...
          <input type="hidden" name="resourceId" value="${resourceTypeAndDetails.resource.internalId}" />

          <a class="btn btn-sm btn-primary" href="/pluginresources/edit/${resourceTypeAndDetails.resource.internalId}"><@spring.message "button.edit"/></a>
