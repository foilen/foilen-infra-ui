...
docker run -ti \
  ...
  /plugins apachephp application bind9 composableapplication dns email infraconfig letsencrypt machine mariadb unixuser urlredirection webcertificate website
